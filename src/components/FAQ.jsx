            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <p class="mb-2 text-gray-500 dark:text-gray-400">TextUtils is a versatile online tool designed to help you manipulate and analyze text effortlessly. You can use it to convert text to uppercase, lowercase, invert the case, or apply an alternating case. It also provides useful statistics like word count, character count, and estimated reading time.</p>
                    </div>
                </div>
                ...
                <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-500 dark:text-gray-400">To transform your text, simply type or paste it into the large text area at the top of the TextUtils interface. Once your text is entered, click on any of the transformation buttons below the text area, such as "UPPERCASE," "lowercase," "INVERT cASE," or "aLtErNaTiNg cAsE." The "Clear" button will reset the text area.</p>
                    </div>
                </div>
