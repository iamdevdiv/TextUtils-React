    ...
    return (
        <div className={
            ...
            ${
                ...
                props.alert.type === "Warning" ? "text-yellow-800 border-yellow-300 dark:text-yellow-300 dark:border-yellow-800" : 
                "text-gray-800 border-gray-300 dark:text-gray-300 dark:border-gray-600"
            }`
        } role="alert">
